...
<head>
    ...
    <link rel="shortcut icon" href="/inspiração/icone.jpg">
...
<body>
                ...
                try {
                    ...
                    if ($resultado->rowCount() > 0) {
                        ...
                        foreach ($resultado as $row) {
                            ...
                            echo "<td class='codigo'>" . $row["codigo_barras"] . "</td>";
                            echo "</tr>";
                        }
                    } else {
    ...
    <div id="meiomid">
        ...
        <div id="botao">
            <p id="txbotao">Selecione a</br> quantidade:</p> <input type="number" id="qtd" min="1" max="100" value="1">
            <button id="barcode-button" onclick="gerarPDF()">Gerar PDF</button>
        </div>
        <div id="meioright" class="color-selection-container">
    ...
    <script>
        ...
        function gerarPDF() {
            ...
            var codigoBarras = document.querySelector('.codigo') ? document.querySelector('.codigo').innerText : '';
